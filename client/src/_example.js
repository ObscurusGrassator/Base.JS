...
b.service.testing.add(async () => {
	...
	b.storage.edit(storage => storage._example_._example.array[0].a = 'aaa');
	...
	b.util.contain(
		b.storage.edit(storage => storage),
		{_example_: {_example: {array: [{a: x => x === 'aaa'}]}}},
		{throwAfterUncontain: 'Storage property get failed'}
	);

	b.storage.edit(storage => storage._example_._example.set('position.x', 23));
	b.util.contain(
		b.storage.edit(storage => storage),
		{_example_: {_example: {position: {x: 23}}}},
